...
public class LoginController {
    ...
    public void onLogin() {
        try {
            ...
            AuthApi.login(new LoginRequest(u, p));
            if(username.getText().equals("joelle"))
                Launcher.go("dashboard.fxml", "Retail Dashboard");
            else{
                Launcher.go("staff-dashboard.fxml", "Retail Dashboard");
            }
